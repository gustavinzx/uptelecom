    ...
    <footer id="rodape" className="bg-[#0b1220] text-slate-400 py-16 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          {/* Logo & About */}
          <div className="bg-[#0b1220]/60 backdrop-blur-md border border-white/10 rounded-[1.5rem] p-6 hover:border-white/20 transition-all duration-300 flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <div className="flex justify-center lg:justify-start gap-3 mt-auto">
          ...
          {/* Menu */}
          <div className="bg-[#0b1220]/60 backdrop-blur-md border border-white/10 rounded-[1.5rem] p-6 hover:border-white/20 transition-all duration-300">
            <h4 className="font-nav font-semibold text-base text-white mb-6 tracking-wide uppercase flex items-center gap-2 before:content-[''] before:w-1 before:h-4 before:rounded-full before:bg-[var(--brand-blue)]">MENU</h4>
            <ul className="space-y-3 text-sm font-nav font-medium">
              <li><a href="#" className="text-slate-400 hover:text-white flex items-center gap-2 transition-all group"><span className="w-0 group-hover:w-3 h-px bg-[var(--brand-blue)] transition-all duration-300" />Home</a></li>
              <li><a href="#vantagens" className="text-slate-400 hover:text-white flex items-center gap-2 transition-all group"><span className="w-0 group-hover:w-3 h-px bg-[var(--brand-blue)] transition-all duration-300" />A Empresa</a></li>
              <li><a href="#planos" className="text-slate-400 hover:text-white flex items-center gap-2 transition-all group"><span className="w-0 group-hover:w-3 h-px bg-[var(--brand-blue)] transition-all duration-300" />Planos</a></li>
              <li><a href="#rodape" className="text-slate-400 hover:text-white flex items-center gap-2 transition-all group"><span className="w-0 group-hover:w-3 h-px bg-[var(--brand-blue)] transition-all duration-300" />Fale Conosco</a></li>
              <li><a href="https://sistema.upconexion.com.br/central_assinante_web/login" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-white flex items-center gap-2 transition-all group"><span className="w-0 group-hover:w-3 h-px bg-[var(--brand-blue)] transition-all duration-300" />Central do Cliente</a></li>
            </ul>
          </div>

          {/* Legal */}
          <div className="bg-[#0b1220]/60 backdrop-blur-md border border-white/10 rounded-[1.5rem] p-6 hover:border-white/20 transition-all duration-300">
            <h4 className="font-nav font-semibold text-base text-white mb-6 tracking-wide uppercase flex items-center gap-2 before:content-[''] before:w-1 before:h-4 before:rounded-full before:bg-[var(--brand-blue)]">LEGAL</h4>
            <ul className="space-y-3 text-sm font-nav font-medium">
          ...
          {/* Contact & Map */}
          <div className="bg-[#0b1220]/60 backdrop-blur-md border border-white/10 rounded-[1.5rem] p-6 hover:border-white/20 transition-all duration-300 flex flex-col">
            <h4 className="font-nav font-semibold text-base text-white mb-6 tracking-wide uppercase flex items-center gap-2 before:content-[''] before:w-1 before:h-4 before:rounded-full before:bg-[var(--brand-blue)]">CONTATO</h4>
            ...
            {/* Google Maps embed */}
            <div className="rounded-2xl overflow-hidden border border-white/10 relative group shadow-lg shadow-black/20 ring-1 ring-white/5 mt-auto">
              ...
              <iframe
                ...
                width="100%"
                height="160"
                style={{ border: 0, filter: "grayscale(60%) invert(90%) contrast(90%) brightness(0.9)" }}
        ...
        <div className="pt-8 border-t border-white/10 text-center flex flex-col items-center justify-center gap-8">
          ...
          {/* Security Badge */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-[#0b1220]/60 backdrop-blur-md border border-amber-400/20 px-6 py-5 rounded-2xl max-w-4xl w-full sm:w-auto shadow-[0_0_25px_rgba(251,191,36,0.06)] text-left">
            ...
            <p className="leading-relaxed text-sm text-slate-300 font-medium">
              <strong className="text-amber-400 block mb-1 tracking-wide uppercase text-xs font-nav font-bold">Aviso de Segurança</strong>
