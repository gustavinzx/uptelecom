...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative w-full overflow-hidden bg-[#0b1220] min-h-[85vh] md:min-h-[750px] flex items-center pt-24 md:pt-32">
        ...
        <CarouselContent className="h-full">
          {slides.map((slide) => (
            <CarouselItem key={slide.id} className="h-full">
              <div className="relative w-full h-[85vh] md:h-[750px] flex items-center">
