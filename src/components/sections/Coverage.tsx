...
export default function Coverage() {
  return (
    <section id="cobertura" className="py-24 relative overflow-hidden bg-fixed bg-cover bg-center" style={{ backgroundImage: "url('/imgs/Cidades.webp')" }}>
      <DarkImageOverlay />
      
      <Reveal direction="up" className="max-w-6xl mx-auto px-6 relative z-10">
        
        <div className="flex flex-col items-center text-center mb-16">
          <div className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-[var(--brand-blue)]/10 border border-[var(--brand-blue)]/30 text-[var(--brand-blue)] text-xs font-bold tracking-widest uppercase mb-5 backdrop-blur-md">
            <span className="w-1.5 h-1.5 rounded-full bg-[var(--brand-blue)] animate-pulse" />
            <span>Presença Regional</span>
          </div>
          <div className="flex items-center justify-center w-16 h-16 rounded-full bg-[var(--brand-blue)]/10 text-[var(--brand-blue)] mb-6 shadow-[0_0_30px_rgba(0,85,255,0.2)]">
            <MapPin size={32} />
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          ...
          <div className="relative bg-[#0b1220]/80 backdrop-blur-xl border border-white/10 rounded-[2rem] overflow-hidden flex flex-col shadow-2xl group hover:border-[var(--brand-blue)]/30 hover:shadow-[0_10px_40px_rgba(0,85,255,0.15)] transition-all duration-300">
            <div className="absolute -top-10 -left-10 w-40 h-40 bg-[var(--brand-blue)]/10 blur-[80px] rounded-full pointer-events-none z-0" />
            ...
            <div className="p-8 flex flex-col flex-1">
              <div className="flex items-center gap-3 mb-1">
                <div className="w-9 h-9 rounded-full bg-[var(--brand-blue)]/15 border border-[var(--brand-blue)]/30 flex items-center justify-center shrink-0">
              ...
              <p className="text-[var(--brand-primary)] font-bold text-sm tracking-widest uppercase mb-4 ml-12">
                Distrito Federal
              </p>
          ...
          <div className="relative bg-[#0b1220]/80 backdrop-blur-xl border border-white/10 rounded-[2rem] overflow-hidden flex flex-col shadow-2xl group hover:border-[var(--brand-primary)]/30 hover:shadow-[0_10px_40px_rgba(230,0,0,0.15)] transition-all duration-300">
            <div className="absolute -top-10 -left-10 w-40 h-40 bg-[var(--brand-primary)]/10 blur-[80px] rounded-full pointer-events-none z-0" />
            <div className="w-full h-[250px] relative bg-slate-900 border-b border-white/10 overflow-hidden">
              <iframe 
            ...
            <div className="p-8 flex flex-col flex-1">
              <div className="flex items-center gap-3 mb-1">
                <div className="w-9 h-9 rounded-full bg-[var(--brand-primary)]/15 border border-[var(--brand-primary)]/30 flex items-center justify-center shrink-0">
              ...
              <p className="text-[var(--brand-blue)] font-bold text-sm tracking-widest uppercase mb-4 ml-12">
