...
export default function Plans() {
  return (
    <section id="planos" className="py-24 text-white relative overflow-hidden bg-fixed bg-cover bg-center" style={{ backgroundImage: "url('/imgs/familia.jpg')" }}>
      ...
      {/* Content */}
      <Reveal direction="down" className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <h2 className="font-anton text-4xl md:text-5xl lg:text-6xl mb-6 text-white tracking-wide drop-shadow-lg">
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-1 text-slate-900 mb-6">
        <span className="font-anton text-2xl mt-2">R$</span>
        <span className="font-anton text-5xl tracking-normal leading-none">
          {plan.price}
        </span>
        <div className="flex flex-col items-start justify-start">
          <span className="font-anton text-2xl leading-none">,{plan.cents}</span>
